...
podidentity-sa         = "pod-identity-sa"
certmanager-rolename   = "certificate-manager-role"
certmanager-policyname = "certificate-manager-policy"
certmanager-namespace  = "certificate-manager"
certmanager-sa         = "certificate-manager-sa"
extdns-rolename        = "external-dns-role"
extdns-policyname      = "external-dns-policy"
extdns-namespace       = "external-dns"
extdns-sa              = "external-dns-sa"
